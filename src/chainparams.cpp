...
public:
    CMainParams() {
        ...
        // smartnode params
        consensus.nSmartnodePaymentsStartBlock = 250000; // not true, but it's ok as long as it's less then nSmartnodePaymentsIncreaseBlock
        ...
        nFulfilledRequestExpireTime = 60*30; // fulfilled requests expire in 1 hour
